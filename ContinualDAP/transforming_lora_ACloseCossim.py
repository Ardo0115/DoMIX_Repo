...
if __name__ == '__main__':
    ...
    # make directory f'./New_lora_transform_ACloseCossim{ref_dir[:3].upper()}/seq0/Nonesamples/lora_pbatch16_ngpu4_lr5e-04_r8 if not exist
    if not os.path.exists(f'./New_lora_transform_ACloseCossim{ref_dir[:3].upper()}/seq0/Nonesamples/lora_pbatch16_ngpu4_lr5e-04_r8'):
        os.makedirs(f'./New_lora_transform_ACloseCossim{ref_dir[:3].upper()}/seq0/Nonesamples/lora_pbatch16_ngpu4_lr5e-04_r8')
    ...
    os.system(f'cp -a {model_tomerge1} ./New_lora_transform_ACloseCossim{ref_dir[:3].upper()}/seq0/Nonesamples/lora_pbatch16_ngpu4_lr5e-04_r8')

    
    # copy directory of model_tomerge1
    # os.system(f'rsync -av --exclude="model.pt" ./seq0/Nonesamples/lora_pbatch16_ngpu4_lr5e-04_r8/camera_unsup_{splitted_arch} ./New_lora_transform_ACloseCossim{ref_dir[:3].upper()}/seq0/Nonesamples/lora_pbatch16_ngpu4_lr5e-04_r8')
    ...
    for i in range(6):
        ...
        torch.save(model_state1, f'./New_lora_transform_ACloseCossim{ref_dir[:3].upper()}/seq0/Nonesamples/lora_pbatch16_ngpu4_lr5e-04_r8/{ref_dir}/model.pt')
    
    os.system(f'mv ./New_lora_transform_ACloseCossim{ref_dir[:3].upper()}/seq0/Nonesamples/lora_pbatch16_ngpu4_lr5e-04_r8/{ref_dir} ./New_lora_transform_ACloseCossim{ref_dir[:3].upper()}/seq0/Nonesamples/lora_pbatch16_ngpu4_lr5e-04_r8/camera_unsup_{splitted_arch}')
