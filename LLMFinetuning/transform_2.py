...
moving_dir = '/home/ardo0115/workspace/Subspace-Tuning/CR_MR/finetune/math_lora_r=8_epoch2'
# swap ref moving
...
def total_objective_function(A_dict, B1_dict, B_ref_dict):
    total_loss = 0
...
for epoch in tqdm(range(num_epochs), desc="Epochs"):
    optimizer.zero_grad()
    loss = total_objective_function(A_dict, B1_dict, B_ref_dict)
    loss.backward()
    optimizer.step()
...
torch.save(moving_lora, '/home/ardo0115/workspace/Subspace-Tuning/CR_MR/finetune/Bzero_transformed_from-lora-to-Numerical_epoch2/adapter_model.bin')
