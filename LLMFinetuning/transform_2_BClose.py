...
def total_objective_function(A_dict, B1_dict, A1_dict, B_ref_dict, A_ref_dict):
    ...
    for key in A_dict.keys():
        ...
        cos_sim_matrix = (BP_i_norm * B_ref_norm).sum(dim=0)  
        
        # loss_i = (1 - (cos_sim_matrix ** 2)).sum()
        loss_i = 1 / (cos_sim_matrix ** 2).sum()
...
save_dir = '/home/ardo0115/workspace/Subspace-Tuning/CR_MR/finetune/Rank16_Sched_InitId_BcloseCossim_transformed_from-math-to-Numerical_epoch2'
